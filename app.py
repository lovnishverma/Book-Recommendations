...
class AdvancedGoodreadsRecommender:
    ...
    def calculate_popularity_score(self) -> np.ndarray:
        ...
        # Combine ratings count and reviews with different weights
    ...
    def setup_models(self):
        ...
        # Setup TF-IDF for keyword-based search
    ...
    def hybrid_search(self, query: str, num_candidates: int = 100) -> np.ndarray:
        ...
        # Normalize popularity and rating scores
        ...
        combined_scores = (
            0.45 * semantic_scores +          # Semantic similarity
            0.25 * keyword_scores +           # Keyword matching
            0.15 * popularity_scores +        # Book popularity
            0.10 * rating_scores +            # Average rating
            0.05 * (self.df['rating_distribution_score'] / 6.0)  # Rating quality
        )
    ...
    def apply_filters(self, 
        ...
        # Minimum ratings count filter (popularity threshold)
    ...
    def get_book_details(self, idx: int) -> Dict:
        ...
        total_ratings = sum([
            book.get('ratings_5', 0), book.get('ratings_4', 0), 
            book.get('ratings_3', 0), book.get('ratings_2', 0), 
            book.get('ratings_1', 0)
        ])
        ...
        try:
            ...
            for idx in top_indices:
                ...
                if include_explanations:
                    book_details['explanation'] = self.explain_recommendation(
                        user_input, idx, similarity_scores[idx]
                    )
...
def format_recommendations(recommendations: List[Dict]) -> str:
    ...
    for i, book in enumerate(recommendations, 1):
        # Create book entry with rich formatting
        book_entry = f"""
## **{i}. {book['title']}**
